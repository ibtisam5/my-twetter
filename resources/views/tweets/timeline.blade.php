            ...
            {{--menu--}}
              <div class="col-md-4">
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item list-group-item-action">{{__('list')}}</a>
                       <button class=" btn btn-primary mt-3" data-toggle="modal" data-target="#tweetModel">{{__('Tweet')}}</button>
                  </div>
...
<!-- Button trigger modal -->
  ...
  <!-- Modal -->
  <div class="modal fade" id="tweetModel" tabindex="-1" aria-labelledby="tweetModelLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form action="/tweet/create" method="POST">
         @csrf
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="tweetModelLabel">{{__('Create Tweet')}}</h5>
